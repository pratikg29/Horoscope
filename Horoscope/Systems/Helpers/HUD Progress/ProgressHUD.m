...
@synthesize interaction, window, background, hud, image, label,spinnerView;
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	//---------------------------------------------------------------------------------------------------------------------------------------------
	background = nil; hud = nil;image = nil; label = nil,spinnerView = nil;
	//---------------------------------------------------------------------------------------------------------------------------------------------
	self.alpha = 0;
	//---------------------------------------------------------------------------------------------------------------------------------------------
	return self;
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
    ...
    if (spin)[spinnerView startAnimating]; else [spinnerView stopAnimating];
	//---------------------------------------------------------------------------------------------------------------------------------------------
	[self hudSize];
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	if (hud == nil)
	{
        ...
        hud.backgroundColor = [UIColor clearColor];//[UIColor whiteColor];
    ...
    if (spinnerView == nil) {
        spinnerView = [[MMMaterialDesignSpinner alloc] initWithFrame:CGRectMake(0, 0, 45, 45)];
        spinnerView.lineWidth = 4.0;
        spinnerView.tintColor = HUD_SPINNER_COLOR;
        
        // Add it as a subview

    }
    
    if (spinnerView.superview == nil) [hud addSubview:spinnerView];
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
    ...
    [[hud viewWithTag:1000]setFrame:CGRectMake(0, 0, hudWidth, hudHeight)];
	//---------------------------------------------------------------------------------------------------------------------------------------------
	CGFloat imagex = hudWidth/2;
	CGFloat imagey = (label.text == nil) ? hudHeight/2 : 36;
	image.center =  spinnerView.center =  CGPointMake(imagex, imagey);
    spinnerView.center = CGPointMake(hud.frame.size.width/2, hud.frame.size.height/2);
	//---------------------------------------------------------------------------------------------------------------------------------------------
