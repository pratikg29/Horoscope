...
- (void) setImagesContentMode:(UIViewContentMode)mode
{
    ...
    [_bottomImageView setClipsToBounds:YES];
...
{
    imageView.contentMode = [self imagesContentMode];
    ...
    else if ([dataObj isKindOfClass:[NSURL class]])
    {
        ...
        [imageView sd_setImageWithURL:imageURL placeholderImage:kMainPlaceholderImage];
    }
